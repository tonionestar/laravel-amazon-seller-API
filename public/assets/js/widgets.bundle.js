"use strict";
let chart_d = JSON.parse(document.getElementById("chart_d").getAttribute("data-value"));
let chart_w = JSON.parse(document.getElementById("chart_w").getAttribute("data-value"));
...
let box_biggestData1 = document.getElementById("biggestData1");
let box_biggestLabel1 = document.getElementById("biggestLabel1");
let box_biggestData2 = document.getElementById("biggestData2");
let box_biggestLabel2 = document.getElementById("biggestLabel2");
let box_biggestData3 = document.getElementById("biggestData3");
let box_biggestLabel3 = document.getElementById("biggestLabel3");
let box_biggestData4 = document.getElementById("biggestData4");
let box_biggestLabel4 = document.getElementById("biggestLabel4");
let box_lowestData1 = document.getElementById("lowestData1");
let box_lowestLabel1 = document.getElementById("lowestLabel1");
let box_lowestData2 = document.getElementById("lowestData2");
let box_lowestLabel2 = document.getElementById("lowestLabel2");
let box_lowestData3 = document.getElementById("lowestData3");
let box_lowestLabel3 = document.getElementById("lowestLabel3");
let box_lowestData4 = document.getElementById("lowestData4");
let box_lowestLabel4 = document.getElementById("lowestLabel4");
...
var KTChartsWidget35 = function () {
    ...
    return {
        init: function () {   
            ...
            box_lowestData1.innerHTML = "$" + lowestData[0];
            box_lowestLabel1.innerHTML = lowestLabel[0];
            ...
            box_lowestData2.innerHTML = "$" + lowestData[1];
            box_lowestLabel2.innerHTML = lowestLabel[1];

            initChart(chart2, '#kt_charts_widget_35_tab_2', '#kt_charts_widget_35_chart_2', chart2Data, chart2Labels, false);

            // _______________________________________________________________//
            // Generate chart labels for $chart_m (today to 1 month ago, every day)
            var currentDateTime = new Date();
            var chart3Labels = [];
            var chart3Data = [];
            ...
            box_biggestData3.innerHTML = "$" + biggestData[2];
            box_lowestData3.innerHTML = "$" + lowestData[2];
            box_lowestLabel3.innerHTML = lowestLabel[2];

            initChart(chart3, '#kt_charts_widget_35_tab_3', '#kt_charts_widget_35_chart_3', chart3Data, chart3Labels, false);

            // Generate chart labels for $chart_y (this month to 1 year ago, every month)
            var currentDateTime = new Date();
            var chart4Labels = [];

            // Generate chart labels for the past 1 year
            for (var i = 0; i < 12; i++) {
                var year = currentDateTime.getFullYear();
                var month = currentDateTime.getMonth() + 1;

                // Format the year and month as per the desired format
                var label = year + ' ' + getMonthName(month);
                chart4Labels.unshift(label);
            ...
            // Get chart4Data
            var currentDateTime = new Date();
            var chart4Data = Array(12).fill(0);

            // Calculate the date range from 12 months ago to the current month
            var startDate = new Date();
            startDate.setMonth(startDate.getMonth() - 11);
            startDate.setDate(1); // Set the day to the first of the month

            for (var i = 0; i < chart_y.length; i++) {
                var order = chart_y[i];
                var orderDate = new Date(order["order_date"]);

                if (orderDate >= startDate && orderDate <= currentDateTime) {
                    var orderMonth = orderDate.getMonth();
                    var chartIndex = (orderMonth + 12 - startDate.getMonth()) % 12;
                    chart4Data[chartIndex] += order["item_total"];
                }
            }

            // Format chart4Data to display two decimal places
            chart4Data = chart4Data.map(function (value) {
                return parseFloat(value.toFixed(2));
            });

            biggestData[3] = chart4Data[0];
            lowestData[3] = Infinity; // Initialize with Infinity as the starting value
            biggestLabel[3] = getLabel(0);
            lowestLabel[3] = getLabel(0);

            for (var j = 0; j < chart4Data.length; j++) {
                if (chart4Data[j] > biggestData[3]) {
                    biggestData[3] = chart4Data[j];
                    biggestLabel[3] = getLabel(j);
                }
                if (chart4Data[j] < lowestData[3] && chart4Data[j] !== 0) {
                    lowestData[3] = chart4Data[j];
                    lowestLabel[3] = getLabel(j);
                }
            }

            function getLabel(index) {
                var currentDate = new Date();
                currentDate.setMonth(currentDate.getMonth() - (11 - index));
                return currentDate.toLocaleString('default', { month: 'long' });
            }

            box_biggestLabel4.innerHTML = biggestLabel[3];
            box_biggestData4.innerHTML = "$" + biggestData[3];
            box_lowestData4.innerHTML = "$" + lowestData[3];
            box_lowestLabel4.innerHTML = lowestLabel[3];
